...
CREATE TABLE experiment_protocols (
 ...
 assignment_algorithm TEXT NOT NULL CHECK(assignment_algorithm='psyche_sha256_balanced_rank'),
 assignment_version TEXT NOT NULL CHECK(assignment_version='sha256-rank-v1'), seed INTEGER NOT NULL CHECK(seed=6062044),
