...
def _expected_schemas(version: int) -> dict[str, list[str]]:
    ...
    try:
        (initialize_personal_v10 if version == 10 else initialize_personal_v11 if version == 11 else initialize_personal_v12 if version == 12 else initialize_personal_v13 if version == 13 else initialize_personal_v14 if version == 14 else initialize_personal_v15 if version == 15 else initialize_personal_v16)(reference)
        return {
            table: [row[1] for row in reference.execute(f"PRAGMA table_info({table})")]
            for table in (PERSONAL_V10_INVENTORY if version == 10 else PERSONAL_V11_INVENTORY if version == 11 else PERSONAL_V12_INVENTORY if version == 12 else PERSONAL_V13_INVENTORY if version == 13 else PERSONAL_V14_INVENTORY if version == 14 else PERSONAL_V15_INVENTORY if version == 15 else PERSONAL_V16_INVENTORY)
        }
    finally:
        reference.close()
...
def _package_body(connection: Any) -> dict[str, Any]:
    ...
    elif versions == (10, 11, 12, 13, 14, 15, 16):
        version, inventory, format_version = 16, PERSONAL_V16_INVENTORY, PERSONAL_V16_FORMAT_VERSION
    else:
...
def verify_personal_package_structure(package: Any) -> bool:
    ...
    try:
        ...
        inventory = PERSONAL_V10_INVENTORY if version == 10 else PERSONAL_V11_INVENTORY if version == 11 else PERSONAL_V12_INVENTORY if version == 12 else PERSONAL_V13_INVENTORY if version == 13 else PERSONAL_V14_INVENTORY if version == 14 else PERSONAL_V15_INVENTORY if version == 15 else PERSONAL_V16_INVENTORY if version == 16 else ()
        expected_format = PERSONAL_V10_FORMAT_VERSION if version == 10 else PERSONAL_V11_FORMAT_VERSION if version == 11 else PERSONAL_V12_FORMAT_VERSION if version == 12 else PERSONAL_V13_FORMAT_VERSION if version == 13 else PERSONAL_V14_FORMAT_VERSION if version == 14 else PERSONAL_V15_FORMAT_VERSION if version == 15 else PERSONAL_V16_FORMAT_VERSION if version == 16 else -1
        if (
...
def restore_personal_package(package: dict[str, Any], connection: Any) -> None:
    ...
    (initialize_personal_v10 if version == 10 else initialize_personal_v11 if version == 11 else initialize_personal_v12 if version == 12 else initialize_personal_v13 if version == 13 else initialize_personal_v14 if version == 14 else initialize_personal_v15 if version == 15 else initialize_personal_v16)(connection)
    try:
        ...
        inventory = PERSONAL_V10_INVENTORY if version == 10 else PERSONAL_V11_INVENTORY if version == 11 else PERSONAL_V12_INVENTORY if version == 12 else PERSONAL_V13_INVENTORY if version == 13 else PERSONAL_V14_INVENTORY if version == 14 else PERSONAL_V15_INVENTORY if version == 15 else PERSONAL_V16_INVENTORY
