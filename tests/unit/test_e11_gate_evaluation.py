...
from psyche_os.release_evidence.e11_gate import evaluate_evaluation, seal_evaluation
...
def _proved_sealed() -> dict[str, Any]:
    ...
    evaluation["residual_risks"][0]["expires_at"] = "2030-01-01T00:00:00Z"
...
def test_modified_sealed_evaluation_is_rejected() -> None:
    evaluation = _proved_sealed()
    evaluation["residual_risks"][0]["status"] = "CHANGED"
